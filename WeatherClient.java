...
public class WeatherClient{
   ...
   **/
   ...
   /**
   **/
   public void requestHumidityState(ViewState state){
      ...
      command += "time ";
      command += "FROM humiditydata WHERE " + where;
   ...
   **/
   public void requestHumidityData(String message){
      ...
      try{}
         ...
         //Figure out what else to do here...alert the user somehow
         ste.printStackTrace();
      }
      catch(Exception e){
         //TBD for improvement...
         ...
         //this.publishHumdityData(humidityData);
      }
   }
