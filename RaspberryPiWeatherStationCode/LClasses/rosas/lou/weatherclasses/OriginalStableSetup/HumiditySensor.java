...
public class HumiditySensor extends Sensor{
   ...
   private static final double HUMIDITY_GAIN      = 1.0;
   private static final double HUMIDITY_OFFSET    = 0.0;
   ...
   *****************************************************************/
   ...
   /*****************************************************************
   Return the quick temperature read from the device (in celsius)
   *****************************************************************/
   ...
   *****************************************************************/
   public String toString(){
      ...
      string = string.concat("\nTemperature:  ");
      string = string.concat("" + this.getTemperature());
      return string;
   }
