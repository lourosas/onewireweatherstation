...
public class GenericThermalPanel extends JPanel{
   ...
   //////////////////////Constructors/////////////////////////////////
   public GenericThermalPanel(CurrentWeatherController controller){
      super();
      this.setLayout(new BorderLayout());
      this.add(this.setNorthPanel(controller),  BorderLayout.NORTH);
      this.add(this.setCenterPanel(controller), BorderLayout.CENTER);
   }
   ...
   */
   ...
   ////////////////////Private Methods////////////////////////////////
   /**/
   private JPanel setCenterPanel(CurrentWeatherController controller){
   ...
   /**/
   private JPanel setNorthPanel(CurrentWeatherController controller){
      JPanel panel = new JPanel();
